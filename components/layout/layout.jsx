            ...
            <div className="flex flex-col  bg-blue-700 h-full w-[320px]  p-3 ">
                ...
                <div className="menuHolder flex flex-col  h-2/3 mt-12">
                    ...
                    <div className="menuItems text-white font-semibold p-2">
                        <div className={router.pathname.includes('board') ? menuItemActive : menuItem}>
                            <div className="mr-3">
                        ...
                        <div className={router.pathname.includes('friend') ? menuItemActive : menuItem}>
                            <div className="mr-3">
                        ...
                        <div className={router.pathname.includes('profile') ? menuItemActive : menuItem}>
                            <div className="mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
