...
export default function login() {
  ...
  return (
    <div className="w-full max-w-[28rem] m-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-gray-100 h-[28rem] w-[28rem] shadow-md rounded p-12 pb-8 mb-4">
      ...
      <div className=' text-center w-full font-semibold text-blue-800'><Link href='/register'>Create a New Account</Link></div>
